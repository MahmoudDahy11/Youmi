...
TaskModel _taskModelDeserialize(
  ...
  object.scheduledDate = reader.readDateTime(offsets[4]);
...
extension TaskModelQueryWhereSort
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhere> anyScheduledDate() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQueryWhere
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> scheduledDateEqualTo(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> scheduledDateNotEqualTo(
      DateTime scheduledDate) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> scheduledDateLessThan(
    DateTime scheduledDate, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterWhereClause> scheduledDateBetween(
...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> isFlexibleEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByIsFlexible() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFlexible', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByIsFlexibleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFlexible', Sort.desc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByScheduledDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'scheduledDate', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByScheduledDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByIsFlexible() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFlexible', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByIsFlexibleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFlexible', Sort.desc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByScheduledDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'scheduledDate', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByScheduledDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'scheduledDate', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByIsFlexible() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isFlexible');
    });
  }

  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByScheduledDate() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, bool, QQueryOperations> isFlexibleProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isFlexible');
    });
  }

  QueryBuilder<TaskModel, DateTime, QQueryOperations> scheduledDateProperty() {
    return QueryBuilder.apply(this, (query) {
