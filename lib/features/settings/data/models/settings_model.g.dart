...
const SettingsModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'weeklyResetDay': PropertySchema(
      id: 2,
      name: r'weeklyResetDay',
      type: IsarType.long,
    )
  },
...
void _settingsModelSerialize(
  ...
  writer.writeLong(offsets[0], object.reminderHour);
  writer.writeString(offsets[1], object.themeMode);
  writer.writeLong(offsets[2], object.weeklyResetDay);
}
...
SettingsModel _settingsModelDeserialize(
  ...
  object.id = id;
  object.reminderHour = reader.readLong(offsets[0]);
  object.themeMode = reader.readString(offsets[1]);
  object.weeklyResetDay = reader.readLong(offsets[2]);
  return object;
}
...
extension SettingsModelQueryFilter
  ...
  QueryBuilder<SettingsModel, SettingsModel, QAfterFilterCondition>
      weeklyResetDayEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'weeklyResetDay',
        value: value,
      ));
    });
  }
...
extension SettingsModelQuerySortBy
  ...
  QueryBuilder<SettingsModel, SettingsModel, QAfterSortBy>
      sortByWeeklyResetDay() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'weeklyResetDay', Sort.asc);
    });
  }

  QueryBuilder<SettingsModel, SettingsModel, QAfterSortBy>
      sortByWeeklyResetDayDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'weeklyResetDay', Sort.desc);
    });
  }
}
...
extension SettingsModelQueryWhereDistinct
  ...
  QueryBuilder<SettingsModel, SettingsModel, QDistinct>
      distinctByWeeklyResetDay() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'weeklyResetDay');
    });
  }
}
...
extension SettingsModelQueryProperty
  ...
  QueryBuilder<SettingsModel, int, QQueryOperations> reminderHourProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SettingsModel, int, QQueryOperations> weeklyResetDayProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'weeklyResetDay');
    });
  }
}
