...
int _noteModelEstimateSize(
  ...
  bytesCount += 3 + object.markdownContent.length * 3;
...
void _noteModelSerialize(
  ...
  writer.writeString(offsets[1], object.markdownContent);
...
NoteModel _noteModelDeserialize(
  ...
  object.id = id;
  object.markdownContent = reader.readString(offsets[1]);
  object.pinned = reader.readBool(offsets[2]);
...
extension NoteModelQueryWhereSort
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhere> anyPinned() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteModelQueryWhere
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhereClause> titleEqualTo(
      String title) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhereClause> titleNotEqualTo(
      String title) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhereClause> pinnedEqualTo(
      bool pinned) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'pinned',
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhereClause> pinnedNotEqualTo(
      bool pinned) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension NoteModelQueryFilter
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> pinnedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'pinned',
...
extension NoteModelQuerySortBy on QueryBuilder<NoteModel, NoteModel, QSortBy> {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByMarkdownContent() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'markdownContent', Sort.asc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByMarkdownContentDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'markdownContent', Sort.desc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByPinned() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pinned', Sort.asc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByPinnedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteModelQuerySortThenBy
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByMarkdownContent() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'markdownContent', Sort.asc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByMarkdownContentDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'markdownContent', Sort.desc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByPinned() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pinned', Sort.asc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByPinnedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pinned', Sort.desc);
    });
  }
...
extension NoteModelQueryWhereDistinct
  ...
  QueryBuilder<NoteModel, NoteModel, QDistinct> distinctByMarkdownContent(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QDistinct> distinctByPinned() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteModelQueryProperty
  ...
  QueryBuilder<NoteModel, String, QQueryOperations> markdownContentProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'markdownContent');
    });
  }

  QueryBuilder<NoteModel, bool, QQueryOperations> pinnedProperty() {
    return QueryBuilder.apply(this, (query) {
